...
import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QPushButton, QLabel, QDialog, QWidget, QGridLayout, QLineEdit, QInputDialog
from PyQt5.QtCore import Qt

class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RSA, MD4")
        self.resize(450, 300)
    ...
    def task_1(self):
        text, ok = QInputDialog.getText(self, '', 'Wprowadz tekst')
        global md4_digest
        md4_digest = MD4.from_string(text)
        result_window = ResultWindow("Wczytano wiadomosc")
        result_window.exec_()
    ...
    def task_2(self):
        ...
        result_window = ResultWindow("Pomyślnie utworzono pare kluczy")
        result_window.exec_()
    ...
    def task_6(self):
        ...
        result_window = ResultWindow(str(decrypted_message)[2:len(str(decrypted_message))-1])
        result_window.exec_()
